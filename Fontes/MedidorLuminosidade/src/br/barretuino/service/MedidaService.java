...
import br.barretuino.repository.MedicaoDAO;
...
public class MedidaService implements SerialPortEventListener {
	...
	public MedidaService(String portaCOM, int timeOut, int dataRate) throws SQLException{
		dao = new MedicaoDAO();		
		leitura = new Medida();
		TIME_OUT = timeOut;
		DATA_RATE = dataRate;
	...
	**/
	...
	public static void main(String[] args) throws Exception {
		MedidaService main = new MedidaService("COM4", 2000, 9600);
		main.initialize();
